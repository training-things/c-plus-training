...
void remove_ctrl_cstrings(char *destp, char const *sourcep, size_t length) {
    for (size_t i = 0; i < length; ++i) {
        if (sourcep[i] >= 0x20) *destp++ = sourcep[i];
    }
    *destp = 0;
}
...
int test_strings(int test_no, unsigned long multiplier) {
    ...
    std::string s(
            "\07Now is the time\07 for all good men\r\n to come to the aid of their "
            "country. \07");
    std::string test(
    ...
    switch (test_no) {
...
#endif
            std::cout << s.length() << " character argument to remove_ctrl()"
                      << std::endl;
        ...
        case 2: {
            ...
            for (counter_t i = 0; i < iterations; ++i) result = remove_ctrl(s);
        }
            break;
        ...
        case 5: {
            ...
            for (counter_t i = 0; i < iterations; ++i) result = remove_ctrl_refs(s);
        }
            {
        ...
        case 8: {
            ...
            for (counter_t i = 0; i < iterations; ++i) result = remove_ctrl_block(s);
        }
            break;
        ...
        case 10: {
            ...
            for (counter_t i = 0; i < iterations; ++i) result = remove_ctrl_blocks(s);
        }
            break;
        ...
        case 12: {
            ...
            for (counter_t i = 0; i < iterations; ++i) result = remove_ctrl_erase(s);
        }
            {
